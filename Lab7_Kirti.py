...
def project_completion_day(day, days_to_completion):
    ...
    completion_index = (current_index + days_to_completion) % len(days_week)
...
assert parse_log_line('2024-03-05 14:33:02 [WARNING] cache.py Redis connection unstable') == ('2024-03-05 14:33:02', 'WARNING', 'cache.py', 'Redis connection unstable')
assert parse_log_line('2024-03-05 14:33:15 [ERROR] api.py Request handler crashed') == ('2024-03-05 14:33:15', 'ERROR', 'api.py', 'Request handler crashed') 
assert parse_log_line('2024-03-05 14:33:22 [INFO] database.py Attempting reconnect') == ('2024-03-05 14:33:22', 'INFO', 'database.py', 'Attempting reconnect') 
