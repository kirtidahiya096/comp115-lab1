...
num = 5
new_num = num * (10 - 5)   # I added () parentheses to make new_num equal to 25
...
print("\nExercise 4")  
initial_circle_radius = 2 #Step 1: Store the inital circle's radius value 2 
circle_area = 3.14 * initial_circle_radius * initial_circle_radius # Step 2: Calculate the Circle's Area 
print(f"The area of the Circle with radius {2} is {circle_area}.") #Step 3: Printing the Area of the Circle 
...
print("\nExercise 5")
input_day_today = int(input("Enter today's day number")) # Step 1: Asking user to input today's day number 
input_days_trip = int(input("Enter the Trip duration in days")) # Step 2: Asking user to input the duration of the trip in days 
day_after_trip = (input_day_today + input_days_trip) % 7  # Step 3: Calculating what day it will be after their trip using modulus operator 
print(f"The trip started on day {input_day_today} and it lasted for {input_days_trip} number of days. You will be back on the day {day_after_trip}.") # Printing the result using f-string 
